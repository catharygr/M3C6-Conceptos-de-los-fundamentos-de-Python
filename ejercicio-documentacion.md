...
![Diagrama de una clase](class.png)
...
En esta documentación hemos repasado los conceptos fundamentales de Python y desarrollo moderno, entre los que se incluyen:

    •	Clases y objetos
    •	Método __init__
    •	Polimorfismo y métodos dunder
    •	Decoradores
    •	APIs y verbos HTTP (GET, POST, DELETE)
    •	Postman
    •	Bases de datos NoSQL (como MongoDB)

Estos elementos forman la base para comprender la programación orientada a objetos, la interacción entre sistemas y el manejo de datos, habilidades esenciales para cualquier desarrollador.
